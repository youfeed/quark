    ...
    constructor({multi}={}) {
        ...
        <cs-tips id="input-con" dir="${this.errordir}" type="error">
            ...
            ${
                ...
                '<cs-button id="btn-pass" class="btn-right" icon="eye-close" type="flat" shape="circle"></cs-button>'
                :
                ''
            }
            ${
                this.type === 'search'&&!multi?
                '<cs-button id="btn-search" class="btn-right" icon="search" type="flat" shape="circle"></cs-button>'
                :
                ''
            }
            ${
                this.type === 'number'&&!multi?
                '<div class="btn-right btn-number"><cs-button id="btn-add" icon="up" type="flat"></cs-button><cs-button id="btn-sub" icon="down" type="flat"></cs-button></div>'
                :
                ''
            }
        </cs-tips>
